...
class BinaryWriter {
    ...
    static u16(value, writer) {
        let offset = writer.totalSize;
        const last = writer._writes;
        writer._writes = () => { last(); (0, bigint_js_1.writeUInt16LE)(value, writer._buf, offset); };
        writer.totalSize += 2;
    }
    u32(value) {
    ...
    static u32(value, writer) {
        let offset = writer.totalSize;
        const last = writer._writes;
        writer._writes = () => { last(); (0, bigint_js_1.writeUInt32LE)(value, writer._buf, offset); };
        writer.totalSize += 4;
    }
    u64(value) {
    ...
    static u64(value, writer) {
        let offset = writer.totalSize;
        const last = writer._writes;
        writer._writes = () => { last(); (0, bigint_js_1.writeBigUint64Le)(value, writer._buf, offset); };
        writer.totalSize += 8;
    }
    u128(value) {
    ...
    static u128(value, writer) {
        let offset = writer.totalSize;
        const last = writer._writes;
        writer._writes = () => { last(); (0, bigint_js_1.writeBufferLEBigInt)(value, 16, writer._buf, offset); };
        writer.totalSize += 16;
    }
    u256(value) {
    ...
    static u256(value, writer) {
        let offset = writer.totalSize;
        const last = writer._writes;
        writer._writes = () => { last(); (0, bigint_js_1.writeBufferLEBigInt)(value, 32, writer._buf, offset); };
        writer.totalSize += 32;
    }
    u512(value) {
    ...
    static u512(value, writer) {
        let offset = writer.totalSize;
        const last = writer._writes;
        writer._writes = () => { last(); (0, bigint_js_1.writeBufferLEBigInt)(value, 64, writer._buf, offset); };
        writer.totalSize += 64;
    }
    f32(value) {
